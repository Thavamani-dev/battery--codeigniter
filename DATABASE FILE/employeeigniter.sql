...
--
-- Table structure for table `battery_tbl`
--
...
--
-- Dumping data for table `battery_tbl`
--

INSERT INTO `battery_tbl` (`id`, `battery_Name`, `Ah`, `model`) VALUES
...
INSERT INTO `dealer_tbl` (`Did`, `Pid`, `shopName`, `number`, `area`, `common`) VALUES
...
(0, 2, 'test', 'test', 2, '2023-11-15', '2023-11-15', '0000-00-00', '2023-11-14'),
...
(1, 'manicus', 'Camping123$', 1, 1),
(8, 'admin@mail.com', 'codeastro.com', 2, 1),
(9, 'admin', '9677123481', 3, 1),
(10, 'LINDSEYFAIN', 'Camping123$', 4, 1);
...
CREATE TABLE `orders_tbl` (
  ...
  `status` enum('Pending','Approved Contract','Billing','Order Placed','Cancle') DEFAULT 'Pending' COMMENT 'P=Pending,AC=Approved Contract,B=Billing,OP=Order Placed'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `orders_tbl` (`id`, `salesper_id`, `area_id`, `dealer_id`, `date`, `comment`, `urgent`, `status`) VALUES
(2, 2, NULL, 138, '2023-10-18', 'murugan was waste guy', 'y', 'Order Placed'),
(4, 1, NULL, 1, '2023-10-18', 'cash', 'y', 'Approved Contract'),
(5, 2, NULL, 219, '2023-11-14', 'etgw', 'y', 'Pending'),
(7, 1, 1, 1, '2023-12-21', 'test', 'n', 'Pending'),
(8, 1, 1, 1, '2023-12-21', 'test orders', 'n', 'Pending'),
(9, 1, 1, 1, '2023-12-13', 'srgs', 'y', 'Pending'),
(10, 2, 1, 1, '2023-12-13', 'tr', 'n', 'Pending');

-- --------------------------------------------------------

--
-- Table structure for table `order_battery_tbl`
--

CREATE TABLE `order_battery_tbl` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `order_battery_tbl`
--

INSERT INTO `order_battery_tbl` (`id`, `orders_id`, `battery_id`, `battery_Qty`) VALUES
(1, 1, 'AUC-PZ-00PZ600MF', 1),
(2, 1, 'AUC-PZ-00PZ3500R/L', 5),
(3, 2, 'APZ-50-00PZDIN66', 1),
(4, 2, 'AUC-PZ-00PZ6000R/L', 2),
(5, 2, 'AUC-PZ-00NT10000R/L (BIG)', 3),
(6, 3, 'AUC-PZ-00NT13000R (JCB)', 1),
(7, 3, 'AUC-PZ-00PZ600MF', 5),
(8, 3, 'AUC-PZ-00PZ3500R/L', 1),
(9, 4, 'AUC-PZ-00NT9000R/L (BIG)', 1),
(10, 4, 'APZ-54-PZ40B20LB (I 10)', 6),
(11, 4, 'AUC-PZ-000PZ3WMF', 9),
(12, 4, 'AUC-PZ-00NT9000R/L (BIG)', 6),
(13, 4, 'APZ-54-0PZ40B20R/L', 5),
(14, 4, 'PZA-IN-TT230-66', 3),
(15, 5, 'AUC-PZ-00PZ3500R/L', 1),
(16, 5, 'AUC-PZ-00NT9000R/L (BIG)', 5),
(17, 6, 'AUC-PZ-00PZ3500R/L', 1),
(18, 0, 'AUC-PZ-00NT13000R (JCB)', 5),
(19, 1, '2', 1),
(20, 5, 'Z5L', 5),
(21, NULL, 'Z5L', 3),
(22, 0, 'Z5L', 3);
...
CREATE TABLE `staff_tbl` (
  ...
  `pic` varchar(150) DEFAULT 'default-pic.jpg',
...
INSERT INTO `staff_tbl` (`id`, `staff_name`, `gender`, `email`, `mobile`, `dob`, `doj`, `address`, `user_id`, `status`, `pic`, `added_by`, `updated_on`, `added_on`) VALUES
(1, 'Tamil', 'Male', 'Tamil@teraimpluse.in', 9638527410, '2023-12-14', '2023-12-14', 'test address', '3', '0', 'images.jpeg', 5, NULL, '2023-12-14 07:33:00'),
(2, 'vignesh', 'Male', 'vignesh@teraimpluse.in', 9638527410, '2023-12-04', '2023-12-11', 'test', '3', '0', 'download.jpeg', 5, NULL, '2023-12-14 07:33:06'),
(10, 'thava', 'Male', 'thavamani@yaaletech.in ', 9677123481, '2023-12-07', '2023-12-27', 'test', '4', '0', 'default-pic.jpg', 1, NULL, '2023-12-14 09:20:01');
...
--
-- Indexes for table `order_battery_tbl`
--
ALTER TABLE `order_battery_tbl`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `battery_tbl`
--
ALTER TABLE `battery_tbl`
...
--
ALTER TABLE `dealer_tbl`
  MODIFY `Did` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=260;
...
--
-- AUTO_INCREMENT for table `order_battery_tbl`
--
ALTER TABLE `order_battery_tbl`
