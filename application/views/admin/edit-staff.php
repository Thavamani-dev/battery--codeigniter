                    ...
                    <div class="box-body">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="txtcity" value="<?php echo $cnt['staff_name'] ?>" class="form-control" placeholder="City">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Status</label>
                          <input type="text" name="txtstate" value="<?php echo $cnt['staff_name'] ?>" class="form-control" placeholder="State">
                        </div>
                      </div>
