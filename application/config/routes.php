...
$route['insert-orders'] = 'orders/insert';
$route['manage-orders'] = 'orders/manage_orders';
$route['edit-orders/(:num)'] = 'orders/edit/$1';
$route['update-orders'] = 'orders/update';
$route['delete-orders/(:num)'] = 'orders/delete/$1';
